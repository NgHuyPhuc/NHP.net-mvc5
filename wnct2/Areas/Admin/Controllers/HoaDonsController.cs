...
namespace wnct2.Areas.Admin.Controllers
{
    ...
    public class HoaDonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaNV,MaKH,NgayHD,TongTien,TrangThai")] HoaDon hoaDon)
        {
            ...
            ViewBag.MaNV = new SelectList(db.NhanVien, "MaNV", "TenNV", hoaDon.MaNV);
            return View(hoaDon);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaNV,MaKH,NgayHD,TongTien,TrangThai")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
